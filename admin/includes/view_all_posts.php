...
<table class="table table-bordered table-hover">
    ...
    while ($row = mysqli_fetch_assoc($select_posts)) {
        ...
        $post_cat_title_query = mysqli_query($connection, $query);
        confirmQuery($post_cat_title_query);
        while ($row = mysqli_fetch_assoc($post_cat_title_query)) {
        ...
        echo "<td><a href='posts.php?source=edit_post&id={$post_id}'>Edit</td>";
